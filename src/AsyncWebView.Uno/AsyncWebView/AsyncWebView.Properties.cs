...
#region SourceMessage
		...
		/// </summary>
		public Windows.Web.Http.HttpRequestMessage SourceMessage
		{
			get { return (Windows.Web.Http.HttpRequestMessage)GetValue(SourceMessageProperty); }
